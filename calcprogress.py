...
if __name__ == "__main__":
    ...
    bytesPerMusicNote = dol_code_size / 100
    bytesPerHouseUpgrade = dol_data_size / 5
    
    noteCount = math.floor(decomp_code_size / bytesPerMusicNote)
    upgradeCount = math.floor(decomp_data_size / bytesPerHouseUpgrade)

    bytes_to_go_next_note = ((noteCount + 1) * bytesPerMusicNote) - decomp_code_size

    bytes_to_go_next_up = ((upgradeCount + 1) * bytesPerHouseUpgrade) - decomp_data_size
    ...
    print("\nCode bytes to go for next music note:", math.floor(bytes_to_go_next_note)+1)
    print("Data bytes to go for next house upgrade:", math.floor(bytes_to_go_next_up)+1)
